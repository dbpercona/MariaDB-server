...
#define SYS_SEMAPHORE_WAITS_FILE	1
#define SYS_SEMAPHORE_WAITS_LINE	2
#define SYS_SEMAPHORE_WAITS_WAIT_TIME	3
#define SYS_SEMAPHORE_WAITS_WAIT_OBJECT	4
#define SYS_SEMAPHORE_WAITS_WAIT_TYPE	5
#define SYS_SEMAPHORE_WAITS_CREATED_FILE 6
#define SYS_SEMAPHORE_WAITS_CREATED_LINE 7
#define SYS_SEMAPHORE_WAITS_WRITER_THREAD 8
#define SYS_SEMAPHORE_WAITS_RESERVATION_MODE 9
#define SYS_SEMAPHORE_WAITS_READERS	10
#define SYS_SEMAPHORE_WAITS_WAITERS_FLAG 11
#define SYS_SEMAPHORE_WAITS_LOCK_WORD	12
#define SYS_SEMAPHORE_WAITS_LAST_READER_FILE 13
#define SYS_SEMAPHORE_WAITS_LAST_READER_LINE 14
#define SYS_SEMAPHORE_WAITS_LAST_WRITER_FILE 15
#define SYS_SEMAPHORE_WAITS_LAST_WRITER_LINE 16
